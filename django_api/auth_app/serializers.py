...
class UserSerializer(ModelSerializer):
    class Meta:
        model = User
        fields = ["email", "username", "profile_picture", "cards_currency", "games_played", "games_won", "is_online", "roblox_username"]
...
class RegisterSerializer(ModelSerializer):
    class Meta:
        model = User
        fields = ["email", "username", "password", "profile_picture", "roblox_username"]
